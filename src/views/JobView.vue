      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <p class="mb-4">
              ...
              have strong skills in HTML, CSS, and JavaScript, with experience working with modern JavaScript frameworks
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2">
              NewTek Solutions is a leading technology company specializing in web development and digital solutions. We
              pride ourselves on delivering high-quality products and services to our clients while fostering a
